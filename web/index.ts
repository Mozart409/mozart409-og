...
const themeOptions: DropdownOption[] = [ { text: 'Light', value: 'light' }, { text: 'Dark', value: 'dark' } ]

const fileTypeOptions: DropdownOption[] = [ { text: 'PNG', value: 'png' }, { text: 'JPEG', value: 'jpeg' } ]
...
const markdownOptions: DropdownOption[] = [ { text: 'Plain Text', value: '0' }, { text: 'Markdown', value: '1' } ]
...
const imageLightOptions: DropdownOption[] = [
  ...
  { text: 'Logo', value: 'https://og.mozart409.space/logos/logo.svg' }
]
